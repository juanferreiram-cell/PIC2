          ...
          children: [
            ...
            Padding(
              ...
              child: ElevatedButton(
                onPressed: _enviandoComando
                    ? null
                    : () => _enviarComando(0x2A, 'Lab HyN'),
                style: Estilo.boton,
                child: _enviandoComando
                    ? const CircularProgressIndicator(strokeWidth: 2)
                    : const Text('Lab HyN', style: Estilo.botones),
              ),
            ),
            Padding(
              padding: const EdgeInsets.all(28),
              child: ElevatedButton(
                onPressed: _enviandoComando
                    ? null
                    : () => _enviarComando(0x29, 'Lab Mecanica'),
                style: Estilo.boton,
                child: _enviandoComando
                    ? const CircularProgressIndicator(strokeWidth: 2)
                    : const Text('Lab Mecanica', style: Estilo.botones),
              ),
            ),
            Padding(
              padding: const EdgeInsets.all(28),
              child: ElevatedButton(
                onPressed: _enviandoComando
                    ? null
                    : () => _enviarComando(0x2B, 'Lab Logistica'),
                style: Estilo.boton,
                child: _enviandoComando
                    ? const CircularProgressIndicator(strokeWidth: 2)
                    : const Text('Lab Logistica', style: Estilo.botones),
              ),
            ),
          ],
        ),
