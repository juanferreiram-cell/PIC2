...
import 'package:interfaz/screens/turismo/carreras.dart';
          ...
          children: [
            ...
            Padding(
              ...
              child: ElevatedButton(
                ...
                style: Estilo.boton,
                child: const Text("Edificio B y C", style: Estilo.botones),
              ),
            ),
            Padding(
              padding: const EdgeInsets.all(28),
              child: ElevatedButton(
                ...
                style: Estilo.boton,
                child: const Text("Edificio E", style: Estilo.botones),
              ),
            ),
            Padding(
              padding: const EdgeInsets.all(28),
              child: ElevatedButton(
                onPressed: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => const Carreras()),
                  );
                },
                style: Estilo.boton,
                child: const Text("Carreras", style: Estilo.botones),
              ),
            ),
          ],
        ),
